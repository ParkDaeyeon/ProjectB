    ...
    public class LetterSpacing : BaseMeshEffect
    {
        ...
        */
        ...
        public void ModifyVertices(List<UIVertex> verts)
        {
            ...
            {
                Debug.LogWarning(e);
                Debug.Log("######################_OMG_!_!_!_!_!_!_!:LETTER_SPACING_ERROR:" + this.name);

                var transList = new LinkedList<Transform>();
                var parent = this.transform;
                while (parent)
                {
                    transList.AddFirst(parent);
                ...
                Debug.LogError("VERY_SUCKS_UNITY_ENGINEER:" + sb.ToString());
                return;
            }
